...
packages = [
    ...
    Package('bat', 'official', ['bare', 'minimal', 'beast']),
    Package('bc', 'official', ['bare', 'minimal', 'beast']),
    Package('bind', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('dunst', 'official', ['bare', 'minimal', 'beast']),
    Package('easy-rsa', 'official', ['bare', 'minimal', 'beast']),
    Package('entr', 'official', ['bare', 'minimal', 'beast']),
    Package('exfat-utils', 'official', ['bare', 'minimal', 'beast']),
    Package('feh', 'official', ['bare', 'minimal', 'beast']),
    Package('ffmpeg', 'official', ['bare', 'minimal', 'beast']),
    Package('firefox', 'official', ['bare', 'minimal', 'beast']),
    Package('freerdp', 'official', ['bare', 'minimal', 'beast']),
    Package('fzf', 'official', ['bare', 'minimal', 'beast']),
    Package('gimp', 'official', ['bare', 'minimal', 'beast']),
    Package('git', 'official', ['bare', 'minimal', 'beast']),
    Package('gnu-netcat', 'official', ['bare', 'minimal', 'beast']),
    Package('go', 'official', ['bare', 'minimal', 'beast']),
    Package('gobuster-git', 'aur', ['bare', 'minimal', 'beast']),
    Package('grc', 'official', ['bare', 'minimal', 'beast']),
    Package('gromit-mpx-git', 'aur', ['bare', 'minimal', 'beast']),
    Package('grub', 'official', ['bare', 'minimal', 'beast']),
    Package('htop', 'official', ['bare', 'minimal', 'beast']),
    Package('i3-gaps', 'official', ['bare', 'minimal', 'beast']),
    Package('i3blocks', 'official', ['bare', 'minimal', 'beast']),
    Package('imagemagick', 'official', ['bare', 'minimal', 'beast']),
    Package('inkscape', 'official', ['bare', 'minimal', 'beast']),
    Package('inxi', 'aur', ['bare', 'minimal', 'beast']),
    Package('john', 'official', ['bare', 'minimal', 'beast']),
    Package('jq', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('mlocate', 'official', ['bare', 'minimal', 'beast']),
    Package('mtools', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('p7zip', 'official', ['bare', 'minimal', 'beast']),
    Package('pandoc-bin', 'aur', ['bare', 'minimal', 'beast']),
    Package('pavucontrol', 'official', ['bare', 'minimal', 'beast']),
    Package('perl-image-exiftool', 'official', ['bare', 'minimal', 'beast']),
    Package('php', 'official', ['bare', 'minimal', 'beast']),
    Package('polkit-gnome', 'official', ['bare', 'minimal', 'beast']),
    Package('postgresql', 'official', ['bare', 'minimal', 'beast']),
    Package('powershell-bin', 'aur', ['bare', 'minimal', 'beast']),
    Package('pptpclient', 'official', ['bare', 'minimal', 'beast']),
    Package('pulseaudio', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('python-pip', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('ranger', 'official', ['bare', 'minimal', 'beast']),
    Package('remmina', 'official', ['bare', 'minimal', 'beast']),
    Package('rsync', 'official', ['bare', 'minimal', 'beast']),
    Package('rustscan', 'aur', ['bare', 'minimal', 'beast']),
    Package('screen', 'official', ['bare', 'minimal', 'beast']),
    Package('screenkey', 'official', ['bare', 'minimal', 'beast']),
    Package('shellcheck', 'official', ['bare', 'minimal', 'beast']),
    Package('simple-mtpfs', 'aur', ['bare', 'minimal', 'beast']),
    Package('sqlitebrowser', 'official', ['bare', 'minimal', 'beast']),
    Package('sxiv', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('thunar', 'official', ['bare', 'minimal', 'beast']),
    Package('thunar-volman', 'official', ['bare', 'minimal', 'beast']),
    Package('tidy', 'official', ['bare', 'minimal', 'beast']),
    Package('tk', 'official', ['bare', 'minimal', 'beast']),
    Package('tmux', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('usbutils', 'official', ['bare', 'minimal', 'beast']),
    Package('vim', 'official', ['bare', 'minimal', 'beast']),
    Package('virtualbox-guest-utils', 'official', ['bare', 'minimal', 'beast']),
    Package('w3m', 'official', ['bare', 'minimal', 'beast']),
    Package('wfuzz-git', 'aur', ['bare', 'minimal', 'beast']),
    Package('wget', 'official', ['bare', 'minimal', 'beast']),
    Package('whois', 'official', ['bare', 'minimal', 'beast']),
    Package('wireshark-qt', 'official', ['bare', 'minimal', 'beast']),
    Package('xclip', 'official', ['bare', 'minimal', 'beast']),
    Package('xcompmgr', 'official', ['bare', 'minimal', 'beast']),
    ...
    Package('zathura', 'official', ['bare', 'minimal', 'beast']),
    Package('zathura-pdf-mupdf', 'official', ['bare', 'minimal', 'beast']),
...
def main():
    ...
    if args.sysconfig:
        ...
        ## ( DEPLOY FILES )
        if mode not in ['bare']:
            installer.deploy_files('/usr/local/alterEGO/filesystem/', '/' )
